  ...
  return (
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-slate-900">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h2 className="text-3xl font-extrabold text-white tracking-tight">ResumeIQ</h2>
        <p className="mt-2 text-sm text-slate-400">
          Resume Intelligence & Explainable Job Matching Platform
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-6 shadow-2xl rounded-2xl sm:px-10 border border-slate-100">
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 flex flex-col gap-3">
            <button
              type="button"
              onClick={fillDemo}
              className="text-xs text-indigo-600 hover:text-indigo-800 font-semibold text-center hover:underline"
            >
